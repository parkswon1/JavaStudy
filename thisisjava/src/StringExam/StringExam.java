package thisisjava.src.StringExam;
...
public class StringExam {
    ...
    public boolean checkProductNumber(String productNumber) {
        if (productNumber.length() == 6 && Character.isLetter(Character.toLowerCase(productNumber.charAt(0))) && Character.isLetter(Character.toLowerCase(productNumber.charAt(1)))){
            for (int i = 2; i < 6; i++) {
